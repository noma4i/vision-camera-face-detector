...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::facedetector::DetectedFace> final {
    static inline margelo::nitro::facedetector::DetectedFace fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
