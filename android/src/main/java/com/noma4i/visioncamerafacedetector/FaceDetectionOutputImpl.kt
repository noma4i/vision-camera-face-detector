...
import com.margelo.nitro.noma4i.visioncamerafacedetector.DetectedFace
import com.margelo.nitro.noma4i.visioncamerafacedetector.DetectedFaceBounds
import com.margelo.nitro.noma4i.visioncamerafacedetector.FaceDetectionFrame
import com.margelo.nitro.noma4i.visioncamerafacedetector.FaceDetectionOrientation
import com.margelo.nitro.noma4i.visioncamerafacedetector.FaceDetectionOutputResult
import com.margelo.nitro.noma4i.visioncamerafacedetector.FaceDetectorClassificationMode
import com.margelo.nitro.noma4i.visioncamerafacedetector.FaceDetectorContourMode
import com.margelo.nitro.noma4i.visioncamerafacedetector.FaceDetectorLandmarkMode
import com.margelo.nitro.noma4i.visioncamerafacedetector.FaceDetectorOptions
import com.margelo.nitro.noma4i.visioncamerafacedetector.FaceDetectorPerformanceMode
import com.margelo.nitro.noma4i.visioncamerafacedetector.HybridFaceDetectionOutputSpec
import java.util.concurrent.Executors
import java.util.concurrent.atomic.AtomicBoolean
import kotlin.math.max

open class FaceDetectionOutputImpl :
  ...
  private fun analyzeImage(
    ...
    detector.process(input)
      .addOnSuccessListener { faces ->
        deliverResult(callback, FaceDetectionOutputResult(faces.map { mapFace(it) }.toTypedArray(), frame))
      }
      .addOnFailureListener {
        deliverResult(callback, FaceDetectionOutputResult(emptyArray(), frame))
      }
  ...
  private fun deliverResult(
    callback: (FaceDetectionOutputResult) -> Unit,
    result: FaceDetectionOutputResult,
  ) {
    if (onFacesDetected !== callback) return
    callback(result)
  }
